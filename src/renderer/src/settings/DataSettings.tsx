    ...
    <>
      ...
      <div className="settings-tab-body">
        ...
        <SettingsGroup title="Contents">
          ...
          <SettingsRow title="Activity summaries" description="Visible progress summaries shown during runs."><SettingsSwitch checked={options.includeReasoningSummaries} label="Include activity summaries" onChange={(checked) => update('includeReasoningSummaries', checked)} /></SettingsRow>

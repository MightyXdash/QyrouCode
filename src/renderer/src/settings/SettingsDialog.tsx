      ...
      <section className="settings-dialog-shell" ref={dialogRef} role="dialog" aria-modal="true" aria-label="Settings" onKeyDown={keepFocusInside}>
        <div className="settings-dialog-layout">
          ...
          <main className="settings-panel">
            ...
            {section === 'general' && <GeneralSettings reasoningEffort={props.reasoningEffort} responseStyle={props.responseStyle} nativeLanguage={props.nativeLanguage} contextWindowTokens={props.contextWindowTokens} speedCounterEnabled={props.speedCounterEnabled} promptRefinementPreferences={props.promptRefinementPreferences} promptRefinementModels={props.promptRefinementModels} onReasoningEffortChange={props.onReasoningEffortChange} onResponseStyleChange={props.onResponseStyleChange} onNativeLanguageChange={props.onNativeLanguageChange} onContextWindowTokensChange={props.onContextWindowTokensChange} onSpeedCounterEnabledChange={props.onSpeedCounterEnabledChange} onPromptRefinementPreferencesChange={props.onPromptRefinementPreferencesChange} />}
